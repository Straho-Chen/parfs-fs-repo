...
#define NOVA_BLOCKNODE_INO (3) /* Storage for data allocator state */
...
void nova_update_super_crc(struct super_block *sb);
void nova_sync_super(struct super_block *sb);
